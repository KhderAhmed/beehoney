...
<div class="content">
    ...
    @endif
        <div class="mb-3 mb-md-4 d-flex justify-content-between">
            <div class="h3 mb-0">Others</div>
    <div> <a href="{{ route('otherscreate') }}" ><button class="btn btn-success">create new Others</button></a></div>
        </div>
<div class="row">
    ...
    <div class="col-12" >
        ...
        <div class="card mb-3 mb-md-4">
            ...
            <div class="card-header">
                <h5 class="font-weight-semi-bold mb-0">All Products Others </h5>
            </div>
                ...
                <div class="table-responsive-xl">
                    <table class="table text-nowrap mb-0">
                        ...
                        <tr>
                            ...
                            <td class="py-3"><img class="img_deg"hight="100" width="100" src="/othersimage/{{$row->image}}"></td>
                            <td class="py-3">{{$row->created_at}}</td>
                            <td class="py-3">
                                <a href="{{route('othersstutaccpet',$row->id)}}"
                                    onclick="return confirm('Are You Sure Accept This')"
                                     class="btn btn-outline-primary"> Active</a>
                 
                             
                             <a href="{{route('othersstutasremove',$row->id)}}"
 ...
 data-unfold-animation-in="fadeIn" data-unfold-animation-out="fadeOut">
                     ...
                     <a class="unfold-link media align-items-center text-nowrap" href="{{route('othersedit',$row->id)}}">
                                        ...
                                        <li class="unfold-item">
                                            ...
                                            href="{{route('othersdelete',$row->id)}}">
