...
<div class="content">
    ...
    @endif
        <div class="mb-3 mb-md-4 d-flex justify-content-between">
            <div class="h3 mb-0">QUEEN</div>
    <div> <a href="{{ route('queencreate') }}" ><button class="btn btn-success">create new Queens</button></a></div>
        </div>
<div class="row">
    ...
    <div class="col-12" >
        ...
        <div class="card mb-3 mb-md-4">
            ...
            <div class="card-header">
                <h5 class="font-weight-semi-bold mb-0">All Products Queen </h5>
            </div>
                ...
                <div class="table-responsive-xl">
                    <table class="table text-nowrap mb-0">
                        ...
                        <tr>
                            ...
                            <td class="py-3"><img class="img_deg"hight="100" width="100" src="/queenimage/{{$row->image}}"></td>
                            <td class="py-3">{{$row->created_at}}</td>
                            <td class="py-3">
                                <a href="{{route('queenstutaccpet',$row->id)}}"
                                    onclick="return confirm('Are You Sure Accept This')"
                                     class="btn btn-outline-primary"> Active</a>
                 
                             
                             <a href="{{route('queenstutasremove',$row->id)}}"
 ...
 data-unfold-animation-in="fadeIn" data-unfold-animation-out="fadeOut">
                                    ...
                                    <ul id="dropDown16" class="unfold unfold-light unfold-top unfold-right position-absolute py-3 mt-1 unfold-css-animation unfold-hidden fadeOut" aria-labelledby="dropDown16Invoker" style="min-width: 150px; animation-duration: 300ms; right: 0px;">
                                        <li class="unfold-item">
                                            <a class="unfold-link media align-items-center text-nowrap" href="{{route('queenedit',$row->id)}}">
